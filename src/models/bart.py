...
class BartEmbeddings(BertEmbeddings):
	"""
...
@add_start_docstrings("""RoBERTa Model with a `language modeling` head on top. """, BART_START_DOCSTRING)
class BartForMaskedLM(BertPreTrainedModel):
	config_class = BartConfig
	pretrained_model_archive_map = BART_PRETRAINED_MODEL_ARCHIVE_MAP
	base_model_prefix = "bart"
	...
	def __init__(self, config):
		...
		self.lm_head = BartLMHead(config)
...
class BartForSequenceClassification(BertPreTrainedModel):
	config_class = BartConfig
	pretrained_model_archive_map = BART_PRETRAINED_MODEL_ARCHIVE_MAP
	base_model_prefix = "bart"
	...
	def __init__(self, config):
		...
		self.bart = BartModel(config)
		self.classifier_ER = BartClassificationHead(config)
		self.classifier_IP = BartClassificationHead(config)
		self.classifier_EX = BartClassificationHead(config)
...
class BartForMultipleChoice(BertPreTrainedModel):
	config_class = BartConfig
	pretrained_model_archive_map = BART_PRETRAINED_MODEL_ARCHIVE_MAP
	base_model_prefix = "bart"
...
class BartForTokenClassification(BertPreTrainedModel):
	config_class = BartConfig
	pretrained_model_archive_map = BART_PRETRAINED_MODEL_ARCHIVE_MAP
	base_model_prefix = "bart"
...
class BartForQuestionAnswering(BertPreTrainedModel):
	config_class = BartConfig
	pretrained_model_archive_map = BART_PRETRAINED_MODEL_ARCHIVE_MAP
	base_model_prefix = "bart"
