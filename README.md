...
This repository contains code base of three separate github repositories.
We have only provided sample data and the some of the models such as BERT, BART, RoBERTa to show case how the model works.




Particularly this repository contains codes and dataset access instructions for the [EMNLP 2020 publication](https://arxiv.org/pdf/2009.08441) on understanding empathy expressed in text-based mental health support.
